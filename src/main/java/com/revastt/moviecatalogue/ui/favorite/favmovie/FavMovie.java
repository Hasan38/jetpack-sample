...
public class FavMovie extends Fragment implements FavoritMovieFragmentCallback {
	...
	private ItemTouchHelper itemTouchHelper = new ItemTouchHelper(new ItemTouchHelper.Callback() {
		...
		public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
			if (getView() != null) {
				...
				FavMovieEntity courseEntity = adapter.getItemById(swipedPosition);
	...
	public void onActivityCreated(@Nullable Bundle savedInstanceState) {
		...
		if (getActivity() != null) {
			...
			viewModel.getMoviePaged().observe(this, courses -> {
				if (courses != null) {
	...
	@Override
	public void onShareClick(FavMovieEntity movieEntity) {
		if (getActivity() != null) {
			...
			ShareCompat.IntentBuilder
					...
					.setText("Segera dapatkan informasi film terbaru "+movieEntity.getTitle())
					.startChooser();
		}
	}

	@Override
	public void onDelete(FavMovieEntity movieEntity) {
